    ...
    <>
      <div className="col-lg-11 col-11  ms-lg-5  p-2 mt-5">
        <div className="text-muted small">
          <h5 className="mt-3 fw-bold small">
          ...
          <br />
          <h5 className="fw-bold small">Flipkart Plus</h5>A world of limitless
          ...
          <br />
          <br />
          <h4 className="fw-bold small">No Cost EMI</h4>In an attempt to make
          high-end products accessible to all, our No Cost EMI plan enables you
          to shop with us under EMI, without shelling out any processing fee.
          Applicable on select mobiles, laptops, large and small appliances,
          furniture, electronics and watches, you can now shop without burning a
          hole in your pocket. If you've been eyeing a product for a long time,
          chances are it may be up for a no cost EMI. Take a look ASAP! Terms
          and conditions apply.
          <br />
          <br /> <h4 className="fw-bold small">EMI on Debit Cards</h4>Did you
          know debit card holders account for 79.38 crore in the country, while
          there are only 3.14 crore credit card holders? After enabling EMI on
          Credit Cards, in another attempt to make online shopping accessible to
          ...
          <br />
          <h4 className="fw-bold small">Mobile Exchange Offers</h4>Get an
          instant discount on the phone that you have been eyeing on. Exchange
          ...
          damage to the screen. If a phone is applicable for an exchange offer,
          you will see the 'Buy with Exchange' option on the product description
          of the phone. So, be smart, always opt for an exchange wherever
          possible. Terms and conditions apply. <br />
          <br />
          <h4 className="fw-bold small">What Can You Buy From Flipkart?</h4>
          <h4 className="fw-bold small">Mobile Phones</h4>From budget phones to
          ...
          <br />
          <h4 className="fw-bold small">Electronic Devices and Accessories</h4>
          ...
          <br />
          <br />
          <h4 className="fw-bold small">Large Appliances</h4>Sleek TVs,
          ...
          <br />
          <br />
          <h4 className="fw-bold small">Small Home Appliances</h4>Find handy and
          ...
          <br />
          <br />
          <h4 className="fw-bold small">Lifestyle</h4>Flipkart,
          ...
          <br />
          <br />
          <h4 className="fw-bold small">Home and Furniture</h4>Moving to a new
          place is never easy, especially if you're buying new furniture. Beds,
          sofa sets, dining tables, wardrobes, and TV units - it's not easy to
          set up everything again. With the hundreds of options thrown at you,
          the ride could be overwhelming. What place is reliable, what furniture
          will stand the test of time? These are questions you must ask before
          you choose a store. Well, our{" "}
          ...
          Flipkart. <br />
          <br />
          <h4 className="fw-bold small">Baby and Kids</h4>Your kids deserve only
          the best. From bodysuits, booties, diapers to strollers, if you're an
          ...
          <br />
          <br />
          <h4 className="fw-bold small">Books, Sports and Games</h4>Work hard
          and no play? We don't believe in that. Get access to best-selling
          ...
          <br />
          <h4 className="fw-bold small">Grocery/Supermart</h4>Launching into the
